...
from beeai_server.api.routes.configuration import router as configuration_router
...
def mount_routes(app: FastAPI):
    ...
    server_router.include_router(configuration_router, prefix="/configuration", tags=["configuration"])
