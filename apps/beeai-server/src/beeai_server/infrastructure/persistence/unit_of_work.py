...
from beeai_server.infrastructure.persistence.repositories.configuration import SqlAlchemyConfigurationRepository
...
class SQLAlchemyUnitOfWork(IUnitOfWork):
    ...
    async def __aenter__(self) -> Self:
        ...
        try:
            ...
            self.configuration = SqlAlchemyConfigurationRepository(self._connection)
